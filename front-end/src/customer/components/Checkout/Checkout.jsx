...
export default function Checkout() {
    ...
    const [addressData, setAddressData] = React.useState({ firstName: null, lastName: null, email: null, state: null, mobile: null, city: null, streetAddress: null })
    ...
    return (
        < div className='checkout-comp'>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.firstName = eve.target.value}
                                        required
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.lastName = eve.target.value}
                                        id="last-name"
                            ...
                            <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.mobile = eve.target.value}
                                        autoComplete="number"
                                        className="p-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.streetAddress = eve.target.value}
                            ...
                            <div className="sm:col-span-2 sm:col-start-1">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.city = eve.target.value}
                                        className="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.state = eve.target.value}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        onChange={(eve) => setAddressData.pincode = eve.target.value}
                                        className="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
            ...
            {activeStep === 3 ? <div className="flow-root pt-20 s">
                <ul role="list" className="-my-10 divide-y divide-gray-200">
